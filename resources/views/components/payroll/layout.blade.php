        ...
        <div class="me-10 w-full pb-4 md:w-[220px]">
            <flux:navlist>
                ...
                @if($canViewTax)
                    <div class="mb-3">
                        <flux:navlist.item 
                            :href="route('payroll.tax-adjustment')" 
                            wire:navigate
                            :class="request()->routeIs('payroll.tax-adjustment') ? 'bg-zinc-100 dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100' : ''"
                        >
                            <div class="flex items-center">
                ...
                @if($canViewTax)
                    <div class="mb-3">
                        <flux:navlist.item 
                            :href="route('payroll.eobi')" 
                            wire:navigate
                            :class="request()->routeIs('payroll.eobi') ? 'bg-zinc-100 dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100' : ''"
                        >
                            <div class="flex items-center">
                                <flux:icon name="adjustments-horizontal" class="w-4 h-4 mr-3" />
                                {{ __('EOBI') }}
                ...
                @if($canViewTax)
                    <div class="mb-3">
                        <flux:navlist.item 
                            :href="route('payroll.lates-adjustment')" 
                            wire:navigate
                            :class="request()->routeIs('payroll.lates-adjustment') ? 'bg-zinc-100 dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100' : ''"
                        >
                            <div class="flex items-center">
