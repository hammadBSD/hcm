    ...
    <x-employees.layout :heading="__('Edit Employee')" :subheading="__('Update employee information')">
        ...
        <div class="space-y-6">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            ...
                            <div class="w-full md:w-1/2 px-2 mb-4">
                                <flux:field>
                                    <flux:label>{{ __('Password') }} <span class="text-zinc-400 text-xs">({{ __('Leave blank to keep current password') }})</span></flux:label>
            ...
            <div class="flex items-center justify-between p-6 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-700">
                <div class="flex items-center gap-3">
                    <flux:button variant="outline" onclick="window.history.back()">
                        {{ __('Cancel') }}
                    </flux:button>
                </div>
