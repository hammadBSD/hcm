<section class="w-full">
    ...
    <x-tasks.layout :heading="__('Tasks')" :subheading="__('Manage and assign tasks to employees')">
        <div class="space-y-6">
        @if(session('success'))
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                    <thead class="bg-zinc-50 dark:bg-zinc-900">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider cursor-pointer" wire:click="sort('description')">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider cursor-pointer" wire:click="sort('due_date')">
                                <div class="flex items-center gap-2">
                                    {{ __('Due Date') }}
                                    @if($sortBy === 'due_date')
                                        <flux:icon name="{{ $sortDirection === 'asc' ? 'chevron-up' : 'chevron-down' }}" class="w-4 h-4" />
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider cursor-pointer" wire:click="sort('status')">
                                <div class="flex items-center gap-2">
                                    {{ __('Status') }}
                                    @if($sortBy === 'status')
                                        <flux:icon name="{{ $sortDirection === 'asc' ? 'chevron-up' : 'chevron-down' }}" class="w-4 h-4" />
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider cursor-pointer" wire:click="sort('created_at')">
                                <div class="flex items-center gap-2">
                                    {{ __('Created') }}
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($task->due_date)
                                        ...
                                        @endif
                                    @else
                                        <span class="text-sm text-zinc-400 dark:text-zinc-500">{{ __('No due date') }}</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-2 text-sm">
                        <div>
                            <span class="font-medium text-zinc-700 dark:text-zinc-300">{{ __('Assigned To:') }}</span>
                            <p class="text-zinc-600 dark:text-zinc-400">{{ $selectedTask->assignedTo->first_name }} {{ $selectedTask->assignedTo->last_name }} ({{ $selectedTask->assignedTo->employee_code }})</p>
                        </div>
                        <div>
