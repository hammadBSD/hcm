<section class="w-full">
    <div class="mb-6">
        <flux:heading>{{ __('My Profile') }}</flux:heading>
        <flux:subheading>{{ __('View your employment information and details') }}</flux:subheading>
    </div>
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-lg text-zinc-600 dark:text-zinc-400">
                            {{ $employee->designation->name ?? ($employee->designation ?? 'Not Assigned') }}
                        </p>
                        <div class="flex items-center gap-4 mt-2">
                            ...
                            <span class="text-sm text-zinc-500 dark:text-zinc-400">
                                Department: <span class="font-medium">{{ $employee->department->title ?? ($employee->department ?? 'Not Assigned') }}</span>
                            </span>
                            <span class="text-sm text-zinc-500 dark:text-zinc-400">
                                Status: 
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <flux:text class="mt-1 text-zinc-500 dark:text-zinc-400">
                    Your employee profile information is not available. Please contact HR for assistance.
                </flux:text>
            </div>
        @endif
    </div>
