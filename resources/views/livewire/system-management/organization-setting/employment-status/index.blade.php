<section class="w-full">
                        ...
                        <tbody class="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                            @forelse($employmentStatuses as $status)
                                <tr class="hover:bg-zinc-100 dark:hover:bg-zinc-600 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-6 whitespace-nowrap">
                                        <flux:badge color="{{ $status->status === 'active' ? 'green' : 'red' }}" size="sm">
                                    ...
                                    <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-1">
                                            <flux:dropdown>
                                                ...
                                                <flux:menu>
                                                    <flux:menu.item icon="pencil" wire:click="editEmploymentStatus({{ $status->id }})">
                                                        {{ __('Edit Employment Status') }}
                                                    </flux:menu.item>
                                                    <flux:menu.item icon="trash" wire:click="deleteEmploymentStatus({{ $status->id }})" wire:confirm="Are you sure you want to delete this employment status?" class="text-red-600">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        ...
                                        <flux:text class="mt-1 text-zinc-500 dark:text-zinc-400">
                                            Get started by creating a new employment status.
                                        </flux:text>
                                    </td>
                                </tr>
                            @endforelse
    ...
    <flux:modal variant="flyout" :open="$showAddEmploymentStatusFlyout" wire:model="showAddEmploymentStatusFlyout">
        <div class="p-6">
            <!-- Header -->
            <div class="mb-6">
                <flux:heading size="lg">{{ $editingId ? 'Edit Employment Status' : 'Add Employment Status' }}</flux:heading>
            </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <flux:field>
                        ...
                        <flux:input 
                            ...
                            placeholder="Enter status code (optional)"
                        />
                        <flux:error name="statusCode" />
                    </flux:field>
                </div>
