                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                                ...
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-1">
                                        <flux:dropdown>
                                            ...
                                            <flux:menu>
                                                <flux:menu.item icon="pencil" wire:click="editGroup(1)">
                                                    {{ __('Edit Group') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="eye" wire:click="viewGroup(1)">
                                                    {{ __('View Details') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="trash" wire:click="deleteGroup(1)" class="text-red-600">
                                                    {{ __('Delete Group') }}
                                                </flux:menu.item>
                                            </flux:menu>
                                        </flux:dropdown>
                            ...
                            <tr class="hover:bg-zinc-100 dark:hover:bg-zinc-600 transition-colors duration-150">
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="h-8 w-8 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center">
                                            <flux:icon name="user-group" class="h-4 w-4 text-green-600 dark:text-green-400" />
                                        </div>
                                        <div>
                                            <div class="font-medium text-zinc-900 dark:text-zinc-100">
                                                Marketing Team
                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="text-sm text-zinc-900 dark:text-zinc-100">
                                        Marketing and promotional activities team
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-1">
                                        <flux:dropdown>
                                            <flux:button variant="ghost" size="sm" icon="ellipsis-horizontal" />
                                            <flux:menu>
                                                <flux:menu.item icon="pencil" wire:click="editGroup(2)">
                                                    {{ __('Edit Group') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="eye" wire:click="viewGroup(2)">
                                                    {{ __('View Details') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="trash" wire:click="deleteGroup(2)" class="text-red-600">
                                                    {{ __('Delete Group') }}
                                                </flux:menu.item>
                                            </flux:menu>
                                        </flux:dropdown>
