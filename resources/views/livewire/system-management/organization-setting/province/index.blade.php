<section class="w-full">
                                ...
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-1">
                                        <flux:dropdown>
                                            ...
                                            <flux:menu>
                                                <flux:menu.item icon="pencil" wire:click="editProvince(1)">
                                                    {{ __('Edit Province') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="eye" wire:click="viewProvince(1)">
                                                    {{ __('View Details') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="trash" wire:click="deleteProvince(1)" class="text-red-600">
                                                    {{ __('Delete Province') }}
                                                </flux:menu.item>
                                            </flux:menu>
                                        </flux:dropdown>
                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="h-8 w-8 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center">
                                            <flux:icon name="map" class="h-4 w-4 text-green-600 dark:text-green-400" />
                                        </div>
                                        <div>
                                            <div class="font-medium text-zinc-900 dark:text-zinc-100">
                                                Sindh
                                ...
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-1">
                                        <flux:dropdown>
                                            <flux:button variant="ghost" size="sm" icon="ellipsis-horizontal" />
                                            <flux:menu>
                                                <flux:menu.item icon="pencil" wire:click="editProvince(2)">
                                                    {{ __('Edit Province') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="eye" wire:click="viewProvince(2)">
                                                    {{ __('View Details') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="trash" wire:click="deleteProvince(2)" class="text-red-600">
                                                    {{ __('Delete Province') }}
                                                </flux:menu.item>
                                            </flux:menu>
                                        </flux:dropdown>
    ...
    <flux:modal variant="flyout" :open="$showAddProvinceFlyout" wire:model="showAddProvinceFlyout">
        <div class="p-6">
            <!-- Header -->
            <div class="mb-6">
                <flux:heading size="lg">Add Province</flux:heading>
            </div>
