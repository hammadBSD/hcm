                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="h-8 w-8 bg-red-100 dark:bg-red-900 rounded-lg flex items-center justify-center">
                                            <flux:icon.shield-check class="h-4 w-4 text-red-600 dark:text-red-400" />
                                        </div>
                                        <div>
                                ...
                                <td class="px-6 py-6 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-1">
                                        <flux:dropdown>
                                            ...
                                            <flux:menu>
                                                <flux:menu.item icon="pencil" wire:click="editRole(1)">
                                                    {{ __('Edit Role') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="eye" wire:click="viewRole(1)">
                                                    {{ __('View Details') }}
                                                </flux:menu.item>
                                                <flux:menu.item icon="document-duplicate" wire:click="duplicateRole(1)">
                                                    {{ __('Duplicate Role') }}
                                                </flux:menu.item>
                                            </flux:menu>
                                        </flux:dropdown>
