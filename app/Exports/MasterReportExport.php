    ...
    public function array(): array
    {
        ...
        foreach ($groups as $group) {
            ...
            $rows[] = [
                ...
                'Basic Salary', 'Allowances', 'Gross Salary', 'Hourly Rate', 'Daily Rate', 'Hourly Deduction Amount', 'Lates Adjustment', 'Deduction Late Days', 'Deduction Absent Days', 'Salary Deduction', 'Bonus', 'Net Salary',
