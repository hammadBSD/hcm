...
class MasterReport extends Component
{
    ...
    public function exportToCsv(): StreamedResponse
    {
        ...
        $headers = [
            ...
            'Basic Salary', 'Allowances', 'Gross Salary', 'Hourly Rate', 'Daily Rate', 'Hourly Deduction Amount', 'Deduction Late Days', 'Deduction Absent Days', 'Salary Deduction', 'Bonus', 'Net Salary',
