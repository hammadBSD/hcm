    ...
    public function submit()
    {
        ...
        DB::transaction(function () {
            DeductionExemption::create([
                ...
                'user_id' => $this->form['scope_type'] === 'user' && $this->form['user_id'] ? (int) $this->form['user_id'] : null,
                'group_id' => $this->form['scope_type'] === 'group' && $this->form['group_id'] ? (int) $this->form['group_id'] : null,
