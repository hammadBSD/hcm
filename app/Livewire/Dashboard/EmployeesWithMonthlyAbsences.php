...
class EmployeesWithMonthlyAbsences extends Component
{
    ...
    /** @var list<array{id: int, name: string, employee_code: ?string, department: string, group: string, absent_count: int}> */
    public array $rows = [];
    ...
    public function loadRows(): void
    {
        ...
        foreach ($employees as $employee) {
            $result = $scanner->evaluateEmployeeAbsentDaysForDashboard($employee, $ym);
            if ($result === null) {
                continue;
            }
    ...
    {
        return view('livewire.dashboard.employees-with-monthly-absences', [
